...
- **FR-011**: The system MUST provide pixel-perfect preview output that matches SharePoint rendering for the selected formatter type in the latest stable Edge and Chrome, using SharePoint v2 schema-compatible HTML/CSS behavior as the baseline.
